...
public class DefaultXmlParser extends DefaultHandler {
   ...
   public void endElement(String uri, String localName, String qName) throws SAXException {
      if (uri == null || uri.length() == 0) {
         ...
         if (currentObj instanceof Project) {
            ...
            } else if (ELEMENT_GIT_PULL_ARGS.equals(currentTag)) {
               project.setGitPullArgs(getText());
            ...
            } else if (ELEMENT_DOCKER_BUILD_ARGS.equals(currentTag)) {
               project.setDockerBuildArgs(getText());
            } else if (ELEMENT_KUBECTL_APPLY_ARGS.equals(currentTag)) {
               project.setKubectlApplyArgs(getText());
   ...
   private void parseForProject(Project parentObj, String parentTag, String qName, Attributes attributes) throws SAXException {
      if (ELEMENT_GIT_URL.equals(qName) || ELEMENT_GIT_CLONE_ARGS.equals(qName) || ELEMENT_GIT_PULL_ARGS.equals(qName) || ELEMENT_MVN_INSTALL_ARGS.equals(qName) || ELEMENT_MVN_TEST_ARGS.equals(qName) || ELEMENT_DOCKER_BUILD_ARGS.equals(qName) || ELEMENT_KUBECTL_APPLY_ARGS.equals(qName) || ELEMENT_JDK_VERSION.equals(qName) || ENTITY_DEPEND_ON.equals(qName)) {
